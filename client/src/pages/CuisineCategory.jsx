...
function CuisineCategory({ handleFavorite, favoriteRecipesIds }) {
  let { id } = useParams();
  ...
  return (
    <div className="recipe">
      ...
      {cuisineCategory.length > 0 && <RecipeList recipes={cuisineCategory} handleFavorite={handleFavorite} favoriteRecipesIds={favoriteRecipesIds} />}
    </div>
  )
};
